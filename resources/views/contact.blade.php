    ...
    <section id="contact-section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="block">
                        <h2 class="subtitle wow fadeInDown" data-wow-duration="500ms" data-wow-delay=".3s">Contact With Me
                        </h2>
                        ...
                        <div class="contact-form">
                            <form id="contact-form" method="post" action="{{ route('messages') }}" role="form">
                                ...
                                <div class="form-group wow fadeInDown" data-wow-duration="500ms" data-wow-delay="1.2s">
                                    <textarea rows="6" placeholder="Message" class="form-control" name="msg" id="message"
                                        required></textarea>
                                </div>
                ...
                <div class="col-md-6">
                    <div class="map-area">
                        ...
                        <div class="map">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d254508.3928070812!2d-74.24789584881651!3d4.648625942144889!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e3f99a6c60f7ccd%3A0xc18fcd6091a051ed!2sMuseo%20del%20Oro!5e0!3m2!1ses-419!2sus!4v1635001123926!5m2!1ses-419!2sus"
    ...
    <section id="call-to-action">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="block">
                        <h2 class="title wow fadeInDown" data-wow-delay=".3s" data-wow-duration="500ms">INTERESTED IN
                            WORKING TOGETHER? ?</h1>
